  ...
  private class MoveState : State<PlayerBehavior2D>
  {
    ...
    public override void OnTick()
    {
      ...
      if (StateMachine.specialCooldownIcon != null) 
        StateMachine.specialCooldownIcon.fillAmount = StateMachine.specialCooldownRemaining / StateMachine.specialCooldown;
      if (StateMachine.actionCooldownIcon != null) 
        StateMachine.actionCooldownIcon.fillAmount = StateMachine.actionCooldownRemaining / StateMachine.actionCooldown;
